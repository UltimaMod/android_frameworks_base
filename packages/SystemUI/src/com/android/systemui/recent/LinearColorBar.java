...
public class LinearColorBar extends LinearLayout {
    ...
    protected void onAttachedToWindow(){
        ...
        mContext.getContentResolver().registerContentObserver(
                Settings.System.getUriFor(Settings.System.RAM_BAR_COLOR_LEFT), false, mSettingsObserver);
        mContext.getContentResolver().registerContentObserver(
                Settings.System.getUriFor(Settings.System.RAM_BAR_COLOR_RIGHT), false, mSettingsObserver);
    }
    ...
    private void updateSettings(){
        ...
        mLeftColor = Settings.System.getInt(resolver, Settings.System.RAM_BAR_COLOR_LEFT, 0xFFFFFFFF);
        mRightColor = Settings.System.getInt(resolver, Settings.System.RAM_BAR_COLOR_RIGHT, 0xFF888888);
        mMiddleColor = mRightColor;
    }
